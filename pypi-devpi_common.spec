...
Version  : 4.1.0
Release  : 14
URL      : https://files.pythonhosted.org/packages/64/63/db7e4bf7361f979dad86b73ec874c14a4d2d1c571d852fb78a8f2b1652d2/devpi-common-4.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/64/63/db7e4bf7361f979dad86b73ec874c14a4d2d1c571d852fb78a8f2b1652d2/devpi-common-4.1.0.tar.gz
...
%prep
%setup -q -n devpi-common-4.1.0
cd %{_builddir}/devpi-common-4.1.0
pushd ..
cp -a devpi-common-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747667750

...
Version  : 4.0.4
Release  : 13
URL      : https://files.pythonhosted.org/packages/4e/9a/3522931638d784eae9c854a023b86b6455db289ca823ab6eb257af433d4a/devpi_common-4.0.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/4e/9a/3522931638d784eae9c854a023b86b6455db289ca823ab6eb257af433d4a/devpi_common-4.0.4.tar.gz
...
Requires: pypi(lazy)
Requires: pypi(packaging_legacy)
...
%prep
%setup -q -n devpi_common-4.0.4
cd %{_builddir}/devpi_common-4.0.4
pushd ..
cp -a devpi_common-4.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713665232
...
cp %{_builddir}/devpi_common-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-devpi_common/cf3eaf29116a37a7d9ba773e776104c067c8e5fc || :
